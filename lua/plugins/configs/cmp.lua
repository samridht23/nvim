...
local options = {
    ...
    mapping = {
        ...
        ["<C-Space>"] = cmp.mapping.complete(), -- open completion without any text
        ["<C-e>"] = cmp.mapping.close(), -- close completion popup
        ["<CR>"] = cmp.mapping.confirm { -- CR is the carriage return and usually Enter in keyboard, Confirm completion
